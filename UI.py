...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.BotCardList = QtWidgets.QTreeView(self.Bot)
        ...
        # Create and configure the battle tab
        self.Battle = QtWidgets.QWidget()
        self.Battle.setObjectName("Battle")
        self.BattleCardList = QtWidgets.QTreeView(self.Battle)
        ...
        self.StrategemCardList = QtWidgets.QTreeView(self.Strategem)
